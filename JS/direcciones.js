let data = [
    ...
    {
    _id: 2,
    "image":"https://ca-times.brightspotcdn.com/dims4/default/8f44167/2147483647/strip/true/crop/7723x5149+0+0/resize/1200x800!/format/webp/quality/80/?url=https%3A%2F%2Fcalifornia-times-brightspot.s3.amazonaws.com%2F58%2Fd9%2F7276465070cd2271bfabff0594f0%2Fffb7f75aed9f4a15b971bc8d300c0fd9",
    "name":"DIRECCIÓN DE DIVERSIDAD SEXUAL",
    ...
    {
    _id: 3,
    "image":"https://1.bp.blogspot.com/-GWtX6irtP2k/XR5tUOjLMqI/AAAAAAAAVPQ/0tPfcMjzzmIxNIM2Q-Ov9znOBSt6uKJMgCLcBGAs/s1600/Captura.PNG",
    "name":"DIRECCIÓN DE MASCULINIDADES",
...
let data2 = data.slice(3); // Obtiene los elementos desde el índice 3 hasta el final

// Obtener los contenedores de cada sección del acordeón
let contenedor1 = document.querySelector(".contenedorSecretarias");
let contenedor2 = document.querySelector(".contenedorOrganismos");


// Renderizar las tarjetas para cada sección del acordeón
renderCards(data1, contenedor1);
renderCards(data2, contenedor2);
